...
class FullScrollableFullCustomFixedItemListScreen extends StatefulWidget {
  /// main needed widgets ...
  final Widget titleWidget;
  final SliverMultiBoxAdaptorWidget sliverMultiBoxAdaptorWidget;
  ...
  const FullScrollableFullCustomFixedItemListScreen(
      {required this.titleWidget,
      required this.sliverMultiBoxAdaptorWidget,
  ...
  @override
  State<FullScrollableFullCustomFixedItemListScreen> createState() =>
      _FullScrollableFullCustomFixedItemListScreenState();
}

class _FullScrollableFullCustomFixedItemListScreenState
    extends State<FullScrollableFullCustomFixedItemListScreen> {
      ...
      child: Builder(builder: (context) {
        return CustomScrollView(slivers: [
          ...
          SliverPadding(
            ...
            sliver: widget.sliverMultiBoxAdaptorWidget,
          ),
        ]);
      }),
    );
